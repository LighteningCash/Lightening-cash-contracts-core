...
async function deposit() {
  ...
  return `lightening-eth-${AMOUNT}-${netId}-${toHex(deposit.preimage, 62)}`
}
...
async function main() {
  ...
  contract = new web3.eth.Contract(require('./build/contracts/ETHLightening.json').abi, CONTRACT_ADDRESS)
